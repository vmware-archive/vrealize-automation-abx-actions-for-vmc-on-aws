...
# Contributing to vrealize-automation-abx-actions-for-vmc-on-aws
...
``` shell
git remote add upstream https://github.com/vmware/vrealize-automation-abx-actions-for-vmc-on-aws.git
